 ...
 * </p>
 *
 * @see org.apache.cassandra.hadoop2.ColumnFamilyOutputFormat
 */
final class ColumnFamilyRecordWriter extends AbstractColumnFamilyRecordWriter<ByteBuffer, List<Mutation>>
{
    ...
    ColumnFamilyRecordWriter(TaskAttemptContext context)
    {
        ...
        this.progressable = new org.apache.cassandra.hadoop2.Progressable(context);
    }

    ColumnFamilyRecordWriter(Configuration conf, org.apache.cassandra.hadoop2.Progressable progressable)
    {
        this(conf);
    ...
    {
        public final String columnFamily = org.apache.cassandra.hadoop2.ConfigHelper.getOutputColumnFamily(conf);
            ...
            while (run || !queue.isEmpty())
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        int port = org.apache.cassandra.hadoop2.ConfigHelper.getOutputRpcPort(conf);
                        client = org.apache.cassandra.hadoop2.ColumnFamilyOutputFormat.createAuthenticatedClient(host, port, conf);
                    }
                    catch (Exception e)
                    {
                        closeInternal();
